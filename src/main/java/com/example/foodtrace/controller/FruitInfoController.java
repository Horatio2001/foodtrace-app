...
//    }
    ...
    public Map<String, Object> addSaveInfoInSql(@RequestParam("SaveID") String SaveID,
                                                ...
                                                @RequestParam(value = "MainUse", required = false) Integer MainUse,
                                                @RequestParam(value = "PreservationFacility", required = false) Integer PreservationFacility,
                                                @RequestParam(value = "GermplasmType", required = false) Integer GermplasmType,
